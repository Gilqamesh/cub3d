...
// floorStep	real world step vector we have to add for each x
//					(parallel to camera plane) adding step by step avoids
//					multiplications with a weight in the loop
// floor		real world coordinates of the leftmost column. This will be
